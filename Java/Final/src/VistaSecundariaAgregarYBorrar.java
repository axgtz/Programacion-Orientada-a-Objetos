...
public class VistaSecundariaAgregarYBorrar extends JFrame{
	...
	protected JLabel nombreATituloLabel, cancionTituloLabel, artistaLabel, nombreACanLabel,nombreCLabel, albumLabel, duracionLabel, generoLabel, bitRateLabel;
	protected JLabel agCBtnLabel1,agCBtnLabel2,borrCBtnLabel1,borrCBtnLabel2, agABtnLabel1, agABtnLabel2, borrABtnLabel1,borrABtnLabel2;
	...
	public static void main(String[] args){
		VistaSecundariaAgregarYBorrar  v = new VistaSecundariaAgregarYBorrar("asd");
	}
}
